...
class flBarChartSeven extends StatefulWidget {
  flBarChartSeven({super.key});
  ...
  @override
  State<flBarChartSeven> createState() => _flBarChartSevenState();
}

class _flBarChartSevenState extends State<flBarChartSeven> {
