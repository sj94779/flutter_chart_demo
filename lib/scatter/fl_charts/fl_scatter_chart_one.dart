...
class flScatterChartOne extends StatefulWidget {
  flScatterChartOne({super.key});

  final blue1 = AppColors.darkBlue;
  final blue2 = AppColors.darkGrey;

  @override
  State<StatefulWidget> createState() => flScatterChartOneState();
}

class flScatterChartOneState extends State<flScatterChartOne> {
  final maxX = 50.0;
  final maxY = 50.0;
  final radius = 8.0;
