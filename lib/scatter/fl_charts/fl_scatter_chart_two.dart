...
class flScatterChartTwo extends StatefulWidget {
  const flScatterChartTwo({super.key});

  @override
  State<StatefulWidget> createState() => _flScatterChartTwoState();
}

class _flScatterChartTwoState extends State {
  int touchedIndex = -1;
              ...
              scatterTouchData: ScatterTouchData(
                ...
                touchTooltipData: ScatterTouchTooltipData(
                  ...
                  getTooltipItems: (ScatterSpot touchedBarSpot) {
                    ...
                    const color1 = AppColors.contentColorWhite;
                    const color2 = AppColors.contentColorWhite;
